...
function processData(data) {
    ...
    if (data.length > 0) {
        ...
        processedData.subHeading = row['sub-heading'] || row['Sub-heading'] || row['sub_heading'] || 'DHIU THESIS FORUM - Research Scholars Platform';
    ...
    if (Object.keys(processedData).length === 0) {
        ...
        processedData.subHeading = 'DHIU THESIS FORUM - Research Scholars Platform';
...
async function createGoogleDocCopy() {
    try {
        ...
        const copyName = `DHIU THESIS FORUM Article Template - ${timestamp}`;
